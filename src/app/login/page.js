      ...
      <div className="relative z-10 w-full h-full flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-4 h-screen">
          ...
          <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-xl p-10 md:p-14 relative flex flex-col justify-center min-h-[750px] md:-ml-24">
            ...
            {error && (
              <div className="mb-4 p-3 rounded-lg bg-red-50 border border-red-200 text-red-600 text-sm flex items-center animate-pulse">
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className={`appearance-none block w-full px-4 py-3 border rounded-xl placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-gray-50 text-gray-900 ${error ? 'border-red-300 focus:ring-red-500' : 'border-gray-200'
                    }`}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex justify-center py-3.5 px-4 border border-transparent rounded-full shadow-sm text-sm font-bold text-white bg-gray-900 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-all disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {loading ? (
